    ...
    "Statement": [
      {
        ...
        "Effect": "Allow",
        "Resource": [
          "aws:aws:firehose:region:account-id:deliverystream/stream-name"
        ]
      }
    ]
  }
  ...
  ```
  {
    "subscriptions": {
      "aws-greengrass-kinesisfirehose": {
        ...
        "source": "aws:aws:lambda:region:aws-greengrass-kinesisfirehose:version",
...
{
  "request": {
    "delivery_stream_arn": "aws:aws:firehose:region:account-id:deliverystream/stream2-name",
